                                ...
                                <div class=" personal">
                                    <div class="card mb-4 mb-xl-0">
                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <input type="file" class="btn btn-primary" name="profile_photo_path" id="profile_photo_path">
                                    ...
                                    <div class="fields">
                                        <div class="input-field">
                                            <label for="inst_crs_name" class="inst_crs_det_lbl">User Name</label>
                                            <input class="inst_crs_inpt" type="text" name="user_name" id="user_name" value="{{ $user->user_name }}">
                                        </div>

                                        <div class="input-field">
                                            <label for="inst_crs_tag"  class="inst_crs_det_lbl">User Phone</label>
                                            <input type="text" class="inst_crs_inpt" name="phone" id="phone" value="{{ $user->phone }}">
                                        </div>
                                        ...
                                        <div class="input-field">
                                            <label for="inst_crs_tag"  class="inst_crs_det_lbl">User Email</label>
                                            <input type="email" class="inst_crs_inpt" name="email" id="email" value="{{ $user->email }}">
                                        </div>

                                        <div class="input-field">
                                            <label for="inst_crs_tag"  class="inst_crs_det_lbl">User Password</label>
                                            <input type="password" class="inst_crs_inpt" name="password" id="password" value="{{ $user->password }}">
                                        </div>
                                        <div >
