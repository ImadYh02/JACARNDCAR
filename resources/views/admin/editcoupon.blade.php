        ...
        <div class="main">
            ...
            <div class="details">
                <div class="recentOrders" style="width: 150%">
                    <form action="{{ route('admin.updateCoupon', $getCoupons['id_cpn']) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div>
                                ...
                                <div class=" personal">
                                    ...
                                    <div class="fields">
                                        <div class="input-field">
                                            <label for="inst_crs_name" class="inst_crs_det_lbl">Coupon Code</label>
                                            <input class="inst_crs_inpt" type="text" name="coupon" id="inst_crs_name" value="{{$getCoupons['coupon']}}">
                                        </div>

                                        <div class="input-field">
                                            <label for="inst_crs_name" class="inst_crs_det_lbl">Number Off</label>
                                            <input class="inst_crs_inpt" type="text" name="off" id="inst_crs_name" value="{{$getCoupons['off']}}">
                                        </div>

                                        <div class="input-field">
                                            <label for="inst_crs_tag"  class="inst_crs_det_lbl">Exp Date</label>
                                            <input type="date" class="inst_crs_inpt" name="exp_date" id="inst_crs_tag" value="{{$getCoupons['exp_date']}}">
                                        </div>
