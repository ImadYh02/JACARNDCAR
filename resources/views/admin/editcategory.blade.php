        ...
        <div class="main">
            ...
            <div class="details">
                <div class="recentOrders" style="width: 150%">
                    <form action="{{ route('admin.updateCategory', $getCategories['id_category']) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div>
                                ...
                                <div class=" personal">
                                    ...
                                    <div class="fields">
                                        <div class="input-field">
                                            <label for="inst_crs_name" class="inst_crs_det_lbl">Category Name</label>
                                            <input class="inst_crs_inpt" type="text" name="name_category" id="name_category" value="{{$getCategories['name_category']}}">
                                        </div>
