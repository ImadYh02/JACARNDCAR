        ...
        <div class="main">
            ...
            <div class="details">
                <div class="recentOrders" style="width: 150%">
                    <form action="{{ route('admin.updateLocation', $getLocations['id_location']) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div>
                                ...
                                <div class=" personal">
                                    <div class="fields">
                                        <div class="input-field">
                                            <label for="inst_crs_name" class="inst_crs_det_lbl">Location Name</label>
                                            <input class="inst_crs_inpt" type="text" name="name_location" id="name_location" value="{{$getLocations['name_location']}}">
                                        </div>
