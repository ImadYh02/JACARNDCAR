                                ...
                                <div class=" personal">
                                    ...
                                    <div class="fields">
                                        <div class="input-field">
                                            ...
                                            <input class="inst_crs_inpt" type="text" name="coupon" id="inst_crs_name" value="">
                                        </div>

                                        <div class="input-field">
                                            <label for="inst_crs_name" class="inst_crs_det_lbl">Number Off</label>
                                            <input class="inst_crs_inpt" type="text" name="off" id="inst_crs_name" value="">
                                        </div>

                                        <div class="input-field">
                                            <label for="inst_crs_tag"  class="inst_crs_det_lbl">Exp Date</label>
                                            <input type="date" class="inst_crs_inpt" name="exp_date" id="inst_crs_tag" value="">
                                        </div>
                                        ...
                                        <button type="rest" class="inst_crs_rst_btn inst_crs_btns" id="inst_crs_rst_btn">Reset</button>
                                            ...
                                            <button type="rest" name="submit"  class="inst_crs_rst_btn inst_crs_btns" id="inst_crs_rst_btn">Create</button>
                                        </button>
                                    </div>
                                </div>
                            </div>
